...
{    
    $sql = "update customers set country ='$_POST[country]', accstatus ='$_POST[accstatus]', loginid='$_POST[loginid]', acctype ='$_POST[acctype]', accpassword ='$_POST[accountpass]', transpassword ='$_POST[transactionpass]', state ='$_POST[state]', city ='$_POST[city]',  phone ='$_POST[phone]',  firstname ='$_POST[fname]',  lastname ='$_POST[lname]', email ='$_POST[email]' WHERE customerid='$_GET[custid]'";
...
<option value="Zimbabwe">Zimbabwe</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input required name="loginid" value="" id="loginid" class="form-control">
 ...
 <div class="col-sm-6">
                      ...
                      <!-- / grid item --> <div class="col-sm-6">
                       ...
                       <!-- / grid item  <div class="col-sm-6">
                        <div class="form-group">
                          <label>Age</label>
                          <input required type="text" value="<? echo $cage?>" name="cage" id="cage" class="form-control">
