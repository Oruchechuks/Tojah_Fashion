		 ...
		 <div class="dt-entry__header">
             ...
             <?php if(isset($_REQUEST['error']))
                 {      if($_REQUEST['error']=='nodetails')
                            ...
                            echo "<script>swal('Error!', 'Dear customer upon every international transfer 10% would be charged from you in other to complete transaction contact customer support via email!', 'error')</script>;";
