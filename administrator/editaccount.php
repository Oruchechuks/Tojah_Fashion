...
{    
    ...
    $target    = "../customer/picture/".basename($_FILES["image"]["name"]);
    if (!empty($image)) {
    $sql = "update customers set country ='$_POST[country]', accstatus ='$_POST[accstatus]', acctype ='$_POST[acctype]', accpassword ='$_POST[accountpass]', transpassword ='$_POST[transactionpass]', state ='$_POST[state]', city ='$_POST[city]', image ='$image',  phone ='$_POST[phone]',  firstname ='$_POST[fname]',  lastname ='$_POST[lname]', cot ='$_POST[cot]',  imf ='$_POST[imf]', email ='$_POST[email]' WHERE customerid='$_GET[custid]'";
    }else{
...
?>                   
                  ...
                  <!-- Form -->
                   <form onsubmit="return valid()" id="form1" name="form1" method="post" action="" enctype="multipart/form-data" >
           <p>&nbsp;<?php echo $logmsg; ?></p>
                    <!-- Grid -->
                    <div class="row">
...
<option value="Zimbabwe">Zimbabwe</option>
 ...
 <div class="col-sm-6">
                        <div class="form-group">
                          <label>COT</label>
                          <input required type="text" value="<? echo $cot?>" name="cot" id="cot"  class="form-control">
                      ...
                      <!-- / grid item --> <div class="col-sm-6">
                        <div class="form-group">
                          <label>IMF</label>
                          <input required type="text" value="<? echo $imf?>" name="imf" id="imf" class="form-control">
