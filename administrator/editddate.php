                ...
                <div class="dt-card__header">
                  ...
                  <div class="dt-card__heading">
                    <div class="d-flex align-items-center">
                      ...
                      <h3 class="dt-card__title text-black">Update Transfer  Date </h3>
                    </div>
                  </div>
                  <!-- /card heading -->
...
<?
$results = mysql_query("SELECT * FROM transfers where id='$_GET[id]'");
$custid=$_GET['transid'];
...
{    
    $date = $_POST[date];
    $sql = "UPDATE `transfers` SET `date` = '$date' WHERE `transfers`.`id` = $_GET[id]";
   
    mysql_query($sql);
   
     echo"<div class='alert alert-success'>
			  <strong>Success!</strong> Transfer Date Updated.
			</div>";
