 ...
 <div class="col-sm-6">
               ...
               <?php $re = mysql_query("SELECT * FROM accountmaster");
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="date" name="accopendate" placeholder="Account Opening Date" class="form-control">
