   ...
   <body class="dt-sidebar--fixed dt-header--fixed">
      ...
      <aside id="main-sidebar" class="dt-sidebar">
         <div class="dt-sidebar__container">
            ...
            <li class="dt-side-nav__item">
               ...
               <span class="dt-side-nav__text">Add New Account</span> </a>
            </li>  
            ...
            <li class="dt-side-nav__item">
               ...
               <span class="dt-side-nav__text">Manage History</span> </a>
            </li>
            
            <li class="dt-side-nav__item">
               <a href="transactions.php" class="dt-side-nav__link" title="Widgets"> <i class="icon icon-user-account icon-fw icon-lg"></i>
               <span class="dt-side-nav__text">Manage Statement</span> </a>
            </li>
            
            <li class="dt-side-nav__item">
               <a href="inbox.php" class="dt-side-nav__link" title="Widgets"> <i class="icon icon-user-account icon-fw icon-lg"></i>
               <span class="dt-side-nav__text">Messages</span> </a>
            </li>
            <li class="dt-side-nav__item">
               <a href="creditcutomer.php" class="dt-side-nav__link" title="Widgets"> <i class="icon icon-user-account icon-fw icon-lg"></i>
               <span class="dt-side-nav__text">Credit Customer</span> </a>
            </li>
            
            <li class="dt-side-nav__item">
               <a href="debitcutomer.php" class="dt-side-nav__link" title="Widgets"> <i class="icon icon-user-account icon-fw icon-lg"></i>
               <span class="dt-side-nav__text">Debit Customer</span> </a>
            </li> 
      ...
      <li class="dt-side-nav__item">
        ...
        <a href="newstaff.php" class="dt-side-nav__link" title="Notifications">
          ...
          <i class="icon icon-mail icon-fw icon-lg"></i> <span class="dt-side-nav__text">Create Employee Account(<?php echo mysql_num_rows($mailreq); ?>)</span>
      ...
      <li class="dt-side-nav__item">
        ...
        <!-- /sub-menu -->
            ...
            <li class="dt-side-nav__item">
               ...
               <span class="dt-side-nav__text">Change Password</span> </a>
            </li>

            <li class="dt-side-nav__item">
               <a href="manageaccount.php" class="dt-side-nav__link" title="Drag & Drop"> <i class="icon icon-send icon-fw icon-lg"></i>
               <span class="dt-side-nav__text">Account Type</span> </a>
            </li>
