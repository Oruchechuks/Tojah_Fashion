...
<?php echo $alert ?>
 ...
 <?php
			  ...
			  while($arrvar = mysql_fetch_array($loan))
				...
				<td>$arrvar[date]</td>"; ?>
<td>
    <a href='editddate.php?id=<?php echo $arrvar[id] ?>'><span class='badge badge-pill badge-warning mb-1 mr-1'>Edit Date</span></a>
     <a href='viewalltransfers.php?delid=<?php echo $arrvar[id] ?>'><span class='badge badge-pill badge-primary mb-1 mr-1'>Delete Transfer</span></a>
